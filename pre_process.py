...
def feature_ext(lists):
	...
	k.append(features)
	print k
	print "Number of positives = "+str(pos)
	print "Number of Negatives = "+str(neg)
	print "Positive ratio = "+str(prat)
	print "Negative ratio = "+str(nrat)
